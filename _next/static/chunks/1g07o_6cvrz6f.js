(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,89389,e=>{"use strict";var a=e.i(43476),r=e.i(71645);let o=`
  .forja {
    --ground: #F6F1EA;
    --surface: #FFFFFF;
    --surface-2: #F1EAE0;
...
<header class="hero">
  ...
  <div class="wrap">
    <div class="brandline">
      ...
      <div class="brandname">Forja Fitness <span>\xb7 plataforma para personal trainers</span></div>
    </div>

    <p class="eyebrow">O que nos diferencia</p>
    <h1>Cada personal, <span class="molten">sua pr\xf3pria academia.</span></h1>
    <p class="lede">
      Um app onde <strong>cada professor comanda o pr\xf3prio mundo</strong> — treinos,
      avalia\xe7\xf5es, comunidade e um Coach de IA — e o aluno s\xf3 enxerga o que \xe9 dele.
    ...
    <div class="stats">
      <div class="stat">
        ...
        <div class="l">Vira app instal\xe1vel no celular, funciona offline</div>
      </div>
      <div class="stat">
        <div class="n"><em>∞</em> academias</div>
        <div class="l">Cada professor isolado, com seus pr\xf3prios alunos</div>
      </div>
      <div class="stat">
...
<main>
  <section class="wrap reveal" aria-labelledby="pilares">
    <div class="sec-head">
      ...
      <h2 id="pilares">O que s\xf3 a Forja entrega</h2>
    </div>
    <div class="pillars">
      ...
      <article class="pillar">
        ...
        <p>Na pr\xe1tica, um app white-label por personal: o aluno s\xf3 v\xea os treinos, a comunidade e as avalia\xe7\xf5es do seu pr\xf3prio professor. O isolamento \xe9 garantido no banco, n\xe3o s\xf3 na tela.</p>
      </article>
      ...
      <article class="pillar">
        ...
        <span class="tag">Coach IA \xb7 Claude</span>
        <h3>Intelig\xeancia que treina junto</h3>
        <p>Para o aluno: ajusta treino, explica execu\xe7\xe3o e sugere alimenta\xe7\xe3o — com cautela para dor e les\xe3o. Para o professor: monta progress\xf5es, redige mensagens e l\xea o engajamento da turma.</p>
      </article>
      ...
      <article class="pillar">
        ...
        <h3>Anamnese 100% personaliz\xe1vel</h3>
        <p>O professor monta a pr\xf3pria ficha — texto, n\xfamero, sim/n\xe3o, m\xfaltipla escolha, obrigat\xf3rias ou n\xe3o — e o aluno responde j\xe1 no cadastro. Nada de formul\xe1rio engessado.</p>
      </article>
      ...
      <article class="pillar">
        ...
        <span class="tag">Execu\xe7\xe3o guiada</span>
        <h3>Treino que acontece na tela</h3>
        <p>Timer de descanso, peso por s\xe9rie, intensidade e "treino ativo" que n\xe3o se perde. S\xf3 libera o pr\xf3ximo depois de concluir — e o professor pode travar os ajustes quando quiser.</p>
      </article>
  ...
  <section class="wrap reveal" aria-labelledby="gestao">
    <div class="sec-head">
      <span class="kicker">Vis\xe3o do professor</span>
      <h2 id="gestao">Gest\xe3o do aluno, ponta a ponta</h2>
    ...
    <div class="feat-grid">
      <div class="feat">
        ...
        <h4>Cadastro rico</h4>
        <p>Nome, anivers\xe1rio, profiss\xe3o, modalidade presencial/online, plano de pagamento e anamnese — de uma vez.</p>
      </div>
      <div class="feat">
        ...
        <h4>Avalia\xe7\xe3o com fotos</h4>
        <p>Hist\xf3rico de avalia\xe7\xf5es e protocolo de periodicidade, com aviso quando \xe9 hora de novas fotos.</p>
      </div>
      <div class="feat">
        ...
        <p>Ciclo de renova\xe7\xe3o por aluno e alertas de "vence em X dias" ou "vencido" — sem deixar dinheiro na mesa.</p>
      </div>
      <div class="feat">
        ...
        <h4>Acesso \xe0 comunidade</h4>
        <p>Liga ou desliga a comunidade por aluno — ideal para quem \xe9 s\xf3 online e n\xe3o entra no grupo.</p>
      </div>
      <div class="feat">
        ...
        <p>Painel mostra quem est\xe1 treinando e quem sumiu, para agir antes de perder o aluno.</p>
      </div>
      <div class="feat">
        ...
        <h4>Nutri\xe7\xe3o e agenda</h4>
        <p>Card\xe1pios com hor\xe1rio das refei\xe7\xf5es e agenda — o acompanhamento n\xe3o para no treino.</p>
      </div>
    </div>
  </section>
  ...
  <section class="wrap reveal" aria-labelledby="engaja">
    <div class="sec-head">
      <span class="kicker">V\xednculo</span>
      <h2 id="engaja">Engajamento que segura o aluno</h2>
      <p>O que faz o aluno abrir o app todo dia — e n\xe3o largar o plano.</p>
    </div>
    <div class="feat-grid">
      <div class="feat">
        ...
        <p>Feed e chat do grupo, com foto e nome pr\xf3prios, indicador de n\xe3o lidas e divisa "novas mensagens".</p>
      </div>
      <div class="feat">
      ...
      <div class="feat">
        ...
        <p>Desafios com curtidas e ranking mensal da turma — a competi\xe7\xe3o saud\xe1vel que vira h\xe1bito.</p>
      </div>
      <div class="feat">
        ...
        <h4>Notifica\xe7\xf5es push</h4>
        <p>Avisos no celular e badge no \xedcone somando mensagens e comunidade — o app chama de volta.</p>
      </div>
      <div class="feat">
        ...
        <p>PWA na tela inicial do celular, com modo offline e navega\xe7\xe3o por deslize entre abas.</p>
      </div>
      <div class="feat">
        ...
        <p>A mesma plataforma atende quem treina na academia e quem \xe9 acompanhado \xe0 dist\xe2ncia.</p>
      </div>
    </div>
  </section>
  ...
  <section class="wrap close reveal">
    <h2>Do cadastro ao ranking, <span class="molten">forjado num s\xf3 app.</span></h2>
    <p>Forja Fitness junta gest\xe3o, treino, avalia\xe7\xe3o, comunidade e IA na palma da m\xe3o — para o professor crescer sem virar ref\xe9m de planilhas.</p>
  ...
  <p class="foot">Forja Fitness \xb7 Diferenciais da plataforma</p>
</main>
`;e.s(["default",0,function(){let e=(0,r.useRef)(null);return(0,r.useEffect)(()=>{let a=e.current;if(!a)return;let r=a.querySelectorAll(".reveal"),o=window.matchMedia("(prefers-reduced-motion: reduce)").matches,t=null;"IntersectionObserver"in window&&!o?(t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add("in"),t?.unobserve(e.target))})},{threshold:.12}),r.forEach(e=>t.observe(e))):r.forEach(e=>e.classList.add("in"));let i=0,n=null,s=null,l=a.querySelector("#embers");if(l&&!o){let e,r=l.getContext("2d"),o=window.devicePixelRatio||1,t=0,d=0,c=[],p=()=>getComputedStyle(a).getPropertyValue("--accent").trim()||"#FF5A2C",h=p(),m=e=>({x:Math.random()*t,y:e?Math.random()*d:d+40*Math.random(),r:(1.6*Math.random()+.5)*o,vy:(.5*Math.random()+.25)*o,vx:(Math.random()-.5)*.3*o,a:.5*Math.random()+.2,tw:.02*Math.random()+.005,ph:6.28*Math.random()}),f=()=>{r.clearRect(0,0,t,d);for(let e=0;e<c.length;e++){let a=c[e];a.y-=a.vy,a.x+=a.vx,a.ph+=a.tw;let t=a.a*(.6+.4*Math.sin(a.ph));if(a.y<-10){c[e]=m(!1);continue}r.beginPath(),r.arc(a.x,a.y,a.r,0,6.2832),r.fillStyle=h,r.globalAlpha=Math.max(0,t),r.shadowColor=h,r.shadowBlur=8*o,r.fill()}r.globalAlpha=1,r.shadowBlur=0,i=requestAnimationFrame(f)},v=()=>{let e;cancelAnimationFrame(i),e=l.parentElement.getBoundingClientRect(),t=l.width=Math.floor(e.width*o),d=l.height=Math.floor(e.height*o),l.style.width=e.width+"px",l.style.height=e.height+"px";let a=Math.max(26,Math.min(60,Math.floor(t/o/26)));c=[];for(let e=0;e<a;e++)c.push(m(!0));f()};v(),n=()=>{clearTimeout(e),e=setTimeout(()=>{h=p(),v()},180)},window.addEventListener("resize",n),(s=new MutationObserver(()=>{h=p()})).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]})}return()=>{t?.disconnect(),n&&window.removeEventListener("resize",n),s?.disconnect(),cancelAnimationFrame(i)}},[]),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{dangerouslySetInnerHTML:{__html:o}}),(0,a.jsx)("div",{className:"forja",ref:e,dangerouslySetInnerHTML:{__html:t}})]})}])}]);