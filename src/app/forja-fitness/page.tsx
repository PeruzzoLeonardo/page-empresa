 ...
 *
 * É uma vitrine standalone com identidade própria (tema "brasa/forja",
 * quente) — deliberadamente diferente do tema azul do site principal.
 * Como cada rota é exportada como um HTML próprio (output: "export"),
 * o <style> abaixo pode sobrescrever com segurança o body escuro e o
 * `cursor: none` herdados de globals.css sem afetar a home.
 *
 * O markup e os SVGs são injetados via dangerouslySetInnerHTML para
 * manter os ícones fiéis ao original; os dois scripts (reveal on scroll
 * e as partículas de brasa no hero) foram portados para o useEffect.
 */
